...
const Detail = ({ productDetail }) => {
  ...
  return (
    <div className='flex gap-10 my-10'>
      <img className='w-[500px] h-[500px] abject-cover' src={productDetail?.image} alt="" />
      <div className="">
        ...
        <div className='flex items-center gap-5'>
          ...
          <input className='w-10 text-center my-4 text-4xl font-bold' type="text" value={quantity} />
